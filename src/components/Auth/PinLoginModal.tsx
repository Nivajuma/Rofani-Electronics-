...
export const PinLoginModal: React.FC<PinLoginModalProps> = ({
  ...
  const [showDemoPins, setShowDemoPins] = useState<boolean>(true);
  ...
  const handleKeyPress = (num: string) => {
    if (pinInput.length < 6) {
      ...
      // Auto check if pin reaches user's pin length
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400">Terminal PIN Authentication</p>
              </div>
            </div>

            <div className="mb-3 flex items-center justify-between text-xs text-slate-400 font-semibold uppercase tracking-wider">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-2xl border transition flex items-center justify-between ${
                      isSelected
                        ? 'bg-slate-800 border-sky-500 shadow-lg shadow-sky-500/10 text-white'
        ...
        <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-between items-center text-center">
          <div className="w-full max-w-sm space-y-4">
            ...
            <div>
              ...
              <h2 className="text-xl font-black text-slate-100">Enter Security PIN</h2>
          ...
          <div className="mt-6 w-full max-w-sm flex items-center justify-between text-xs text-slate-500 pt-3 border-t border-slate-800">
            <span className="flex items-center gap-1 text-[11px]">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" /> KRA compliant session
            </span>
