...
export const INITIAL_USERS: User[] = [
  {
    ...
    name: 'John Doe (Admin)',
    role: 'Admin',
    roles: ['Admin', 'Expenses Role', 'Sales Role', 'Inventory Staff'],
  ...
  },
  {
    ...
    roles: ['Inventory Staff', 'Stock Ins Role', 'Stock Setup Role'],
